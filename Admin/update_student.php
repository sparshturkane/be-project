...
$sql = "update student set s_id='$s_id',s_name='$s_name',s_branch='$s_branch' where s_id='$id'";
...
$sql6 = "update s_profile set s_id='$s_id',f_id='$f_id',s_year='$s_year',s_branch='$s_branch' where s_id='$id'";

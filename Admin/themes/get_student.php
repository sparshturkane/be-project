...
<?php
	...
	$rs = mysqli_query($dbcon,"select count(*) from student");
	$row = mysqli_fetch_row($rs);
	$result["total"] = $row[0];
	$rs = mysqli_query($dbcon,"SELECT student.s_id, student.s_name, student.s_branch, s_login.s_password, student.f_email, student.s_contact FROM student INNER JOIN s_login ON student.s_id = s_login.s_id WHERE student.s_branch ='$m_branch' limit $offset,$rows");

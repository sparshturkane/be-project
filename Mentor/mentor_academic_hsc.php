...
<title>Academic HSC | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_hsc_board" width="50">Board</th>
				<th field="s_hsc_yearop" width="12">Year </th>
				<th field="s_hsc_tmarks" width="20">Marks</th>
				<th field="s_hsc_percentage" width="20" >Percentage</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

...
<title>SEM 3 Attendance | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem3_july" width="30">JULY</th>
				<th field="s_sem3_aug" width="30">AUG</th>
				<th field="s_sem3_sept" width="30">SEPT</th>
				<th field="s_sem3_oct" width="30">OCT</th>
				<th field="s_sem3_nov" width="30">NOV</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

...
<title>Seat No. | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem1_seatno" width="30">SEM 1</th>
				<th field="s_sem2_seatno" width="30">SEM 2</th>
				<th field="s_sem3_seatno" width="30">SEM 3</th>
				<th field="s_sem4_seatno" width="30">SEM 4</th>
				<th field="s_sem5_seatno" width="30">SEM 5</th>
				<th field="s_sem6_seatno" width="30">SEM 6</th>
				<th field="s_sem7_seatno" width="30">SEM 7</th>
				<th field="s_sem8_seatno" width="30">SEM 8</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

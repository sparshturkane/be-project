...
<title>Pointer | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem1_pointer" width="12">SEM 1</th>
				<th field="s_sem2_pointer" width="12">SEM 2</th>
				<th field="s_sem3_pointer" width="12">SEM 3</th>
				<th field="s_sem4_pointer" width="12">SEM 4</th>
				<th field="s_sem5_pointer" width="12">SEM 5</th>
				<th field="s_sem6_pointer" width="12">SEM 6</th>
				<th field="s_sem7_pointer" width="12">SEM 7</th>
				<th field="s_sem8_pointer" width="12">SEM 8</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

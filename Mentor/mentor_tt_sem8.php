...
<title>Sem 8 TT | mentor system</title>
...
<h2>Semester 8</h2>
	...
	<table id="dg" title="Semester 8" style="width:900px;height:500px"
		...
		<thead>
			<tr>
				...
				<th ></th>
				<th ></th>
				<th colspan="2"><?php echo $s_sem8_sub1;  ?></th>
				<th colspan="2"><?php echo $s_sem8_sub2;  ?></th>
				<th colspan="2"><?php echo $s_sem8_sub3;  ?></th>
				<th colspan="2"><?php echo $s_sem8_sub4;  ?></th>
				<th colspan="2"><?php echo $s_sem8_sub5;  ?></th>
				<th colspan="2"><?php echo $s_sem8_sub6;  ?></th>	
			</tr>
			<tr>
				<th field="s_id" width="">ID</th>
				<th field="s_name" width="">Name</th>
				<th field="s_sem8_sub1_tt1" width="">TT 1</th>
				<th field="s_sem8_sub1_tt2" width="">TT 2</th>
				<th field="s_sem8_sub2_tt1" width="">TT 1</th>
				<th field="s_sem8_sub2_tt2" width="">TT 2</th>
				<th field="s_sem8_sub3_tt1" width="">TT 1</th>
				<th field="s_sem8_sub3_tt2" width="">TT 2</th>
				<th field="s_sem8_sub4_tt1" width="">TT 1</th>
				<th field="s_sem8_sub4_tt2" width="">TT 2</th>
				<th field="s_sem8_sub5_tt1" width="">TT 1</th>
				<th field="s_sem8_sub5_tt2" width="">TT 2</th>
				<th field="s_sem8_sub6_tt1" width="">TT 1</th>
				<th field="s_sem8_sub6_tt2" width="">TT 2</th>

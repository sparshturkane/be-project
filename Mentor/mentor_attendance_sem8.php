...
<title>SEM 8 Attendance | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem8_jan" width="30">JAN</th>
				<th field="s_sem8_feb" width="30">FEB</th>
				<th field="s_sem8_mar" width="30">MAR</th>
				<th field="s_sem8_april" width="30">APRIL</th>
				<th field="s_sem8_may" width="30">MAY</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

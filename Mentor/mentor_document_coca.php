...
<title>Co-Curricular Document | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_dlink_coca1" width="30">1</th>
				<th field="s_dlink_coca2" width="30">2</th>
				<th field="s_dlink_coca3" width="30">3</th>
				<th field="s_dlink_coca4" width="30">4</th>
				<th field="s_dlink_coca5" width="30">5</th>
				<th field="s_dlink_coca6" width="30">6</th>
				<th field="s_dlink_coca7" width="30">7</th>
				<th field="s_dlink_coca8" width="30">8</th>
				<th field="s_dlink_coca9" width="30">9</th>
				<th field="s_dlink_coca10" width="30">10</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

...
<title>SEM 4 Attendance | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem4_jan" width="30">JAN</th>
				<th field="s_sem4_feb" width="30">FEB</th>
				<th field="s_sem4_mar" width="30">MAR</th>
				<th field="s_sem4_april" width="30">APRIL</th>
				<th field="s_sem4_may" width="30">MAY</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

...
<title>SEM 5 Attendance | mentor system</title>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_sem5_july" width="30">JULY</th>
				<th field="s_sem5_aug" width="30">AUG</th>
				<th field="s_sem5_sept" width="30">SEPT</th>
				<th field="s_sem5_oct" width="30">OCT</th>
				<th field="s_sem5_nov" width="30">NOV</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

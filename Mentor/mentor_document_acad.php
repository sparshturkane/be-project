...
<title>Academic Document | mentor system</title>
...
<div class="container" style="display: block;">
   ...
   <div class="row">
		<div class="col-md-8">
<h2>Document Academic Others</h2>
	...
	<table id="dg" title="Student List" style="width:1000px;height:500px"
		...
		<thead>
			<tr>
				...
				<th field="s_dlink_acad1" width="30">1</th>
				<th field="s_dlink_acad2" width="30">2</th>
				<th field="s_dlink_acad3" width="30">3</th>
				<th field="s_dlink_acad4" width="30">4</th>
				<th field="s_dlink_acad5" width="30">5</th>
				<th field="s_dlink_acad6" width="30">6</th>
				<th field="s_dlink_acad7" width="30">7</th>
				<th field="s_dlink_acad8" width="30">8</th>
				<th field="s_dlink_acad9" width="30">9</th>
				<th field="s_dlink_acad10" width="30">10</th>
			</tr>
		</thead>
	</table>
	<!--<div id="toolbar">

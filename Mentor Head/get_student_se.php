...
<?php
	...
	$rs = mysqli_query($dbcon,"SELECT count(*) FROM s_profile WHERE s_branch='$m_branch' AND s_year='SE'");
	...
	$rs = mysqli_query($dbcon," SELECT 	student.s_id,
								...
								INNER JOIN s_login
									ON s_login.s_id = s_profile.s_id WHERE student.s_branch ='$m_branch' AND s_profile.s_year='SE' limit $offset,$rows");

...
$sql = "update faculty set f_id='$f_id',f_name='$f_name',f_email='$f_email',f_contact='$f_contact' where f_id='$id'";
$sql2 = "update f_login set f_id='$f_id',f_password='$f_password' where f_id='$id'";
